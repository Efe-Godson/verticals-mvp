...
export default function DataPanel({ form }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      <div style={{ padding: '0.9rem 1rem 0.6rem', borderBottom: '1px solid var(--color-border)' }}>
        ...
        <div style={{ fontWeight: 700, fontSize: '0.95rem', marginTop: '0.15rem' }}>{form?.name || 'Dataset'}</div>
        <div style={{ fontSize: '0.75rem', color: 'var(--color-muted)' }}>{fields.length} fields</div>
      </div>
